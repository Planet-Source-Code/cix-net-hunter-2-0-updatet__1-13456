...
Begin VB.Form frmSettings 
   ...
   Begin VB.CommandButton Command1 
      ...
      Width           =   1095
   End
   Begin VB.TextBox txtMediafiles 
      Appearance      =   0  'Flat
      Height          =   285
      Left            =   120
      TabIndex        =   6
   ...
   Begin VB.CheckBox Check1 
      BackColor       =   &H00FFFFFF&
      Caption         =   "Use realname For the Media files "
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9
         Charset         =   0
...
strFilters = txtMediafiles.Text 'GetSetting("Net Hunter", "Settings", "Filters", ".mp3/.mov/.jpg/.gif/.bmp/.swf/.mpg/.mpeg/.viv/.ra/.rar/.zip/.ram/.js/.avi/.asf")
...
Private Sub Form_Load()
 ...
 strFilters = GetSetting("Net Hunter", "Settings", "Filters", ".mp3/.mov/.jpg/.gif/.bmp/.swf/.mpg/.mpeg/.viv/.ra/.rar/.zip/.ram/.js/.avi/.asf")
 Hunter.Usename = GetSetting("Net Hunter", "Settings", "Names", 2)
 If Hunter.Usename = 1 Then
  Check1.Value = Checked
 Else
  Check1.Value = Unchecked
End If
 txtMediafiles.Text = strFilters
End Sub
